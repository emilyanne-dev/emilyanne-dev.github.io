...
def build_about():
  ...
  <section class="about-section">
    ...
    <div class="about-grid">
      <div class="about-col">
        <div class="about-bio">
          <p>Emily is a Creative Producer based in San Francisco in the marketing and advertising space with almost a decade of experience. Raised in a farming family, she currently enjoys working with food, beverage and beyond at Instacart. In her free time, she enjoys experimenting in the kitchen. Have a recipe to share? Please drop below.</p>
        </div>
